...
void PlayerLandEffect::SetScaleComponent()
{
...
void PlayerLandEffect::SetSpdComponent()
{
...
void PlayerLandEffect::SetResourceComponent()
{
	//	リソース
...
std::unique_ptr<MNE::ParticleEmitter>& PlayerLandEffect::GetEmitter()
{
	...
	//	エミッターの型設定
	std::unique_ptr<EmitterType> type = std::make_unique<EmitterCircumType>();
