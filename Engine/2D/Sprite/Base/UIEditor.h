...
#pragma endregion
	...
	#pragma endregion
		...
		void DeleteTag();
		void EditTag();
		void DeleteSpriteFromList(std::unordered_map<std::string, MNE::Sprite>& sprites);
		void AddSprite(std::unordered_map<std::string, MNE::Sprite>& sprites);
		void ReNameSprite(std::unordered_map<std::string, MNE::Sprite>& sprites, std::pair<const std::string, MNE::Sprite> data);
