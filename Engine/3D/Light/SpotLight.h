...
namespace MNE
{
	...
	private:
		...
		MyMath::Vector3D pos_ = { 0,0,0 };
		MyMath::Vector3D color_ = { 1,1,1 };
		MyMath::Vector3D atten_ = { 1,1,1 };
		MyMath::Vector2D factorAngleCos_ = { 0.5f,0.2f };
	...
	#pragma region Getter
		...
		* @return pos_の値
		*/
		const MyMath::Vector3D& GetLightPos() { return pos_; }
		/**
		* @fn GetLightColor()
		* color_のGetter関数
		* @return color_の値
		...
		* @return atten_の値
		*/
		const MyMath::Vector3D& GetLightAtten() { return atten_; }
		/**
		* @fn GetLightFactorAngleCos()
		* factorAngleCos_のGetter関数
		* @return factorAngleCos_の値
		*/
		const MyMath::Vector2D& GetLightFactorAngleCos() { return factorAngleCos_; }
	...
	#pragma region Setter
		...
		*/
		void SetLightPos(const MyMath::Vector3D& pos) { pos_ = pos; }
		/**
		...
		*/
		void SetLightAtten(const MyMath::Vector3D& atten) { atten_ = atten; }
		/**
		* @fn SetLightFactorAngle(const Vector2D&)
		* factorAngle_の値を変更するための関数
		* @param factorAngle factorAngle_の変更後の値
		*/
		void SetLightFactorAngle(const MyMath::Vector2D& factorAngle);
